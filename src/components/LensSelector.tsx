...
const LENSES: Lens[] = [
  {
    ...
    emoji: '🌴',
    label: 'Nusantara',
    desc: 'Indonesian cultural analogies: Javanese, Sundanese, Malay',
  ...
  },
  {
    ...
    emoji: '🌍',
    label: 'Western',
    desc: 'Western cultural analogies: American/European modern pop culture',
  ...
  },
  {
    ...
    emoji: '☪️',
    label: 'Islami',
    desc: 'Analogies based on Islamic values and stories',
  ...
  },
  {
    ...
    emoji: '🐉',
    label: 'Tionghoa',
    desc: 'Analogies based on Chinese culture and Confucian philosophy',
